...
@AllArgsConstructor
@Entity
@Table(name = "ZZ_FAKE_USERS_ENRICH")
public class ZzFakeUsersEnrich extends TwitterItem {

    @EmbeddedId
    private ZzFakeUsersEnrichKey zzFakeUsersEnrichKey;
